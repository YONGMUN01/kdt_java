...
public class Variable02 {	// 클래스 중괄호 영역 시작
	public static void main(String[] args) {	// main 메소드 중괄호 영역 시작
		// 여러개의 변수를 선언하기
		int num1 = 10;
		int num2 = 20;	// 정수형 num2라는 변수선언 후 20이라는 정수형 값을 대입
		int num3 = 30;
		...
		// 정수형 변수 num4에 10라는 정수형 값을 저장, num5에 20이라는 정수형값 저장, num6에 30이라는 정수형값을 저장
		// 여러개의 변수를 선언 시 같은 타입이라면 ,를 이용하여 여러개 선언할 수 있다.
		//num4 = 10;
		//num5 = 20;
		//num6 = 30;
