...
public class TypeCasting02 {
	public static void main(String[] args) {
		...
		System.out.println("long 타입 num2의 값 : " + num2 + ", int 타입으로 변환된 값 : " + result2);
		...
		// int의 범위는 32bit 자료형
		// 나타낼 수 있는 값의 범위 -2,147,483,648 ~ 2,147,483,647
		// long에서 int로 변환 => 2147483648은 int의 범위를 초과하므로 상위비트(초과된 비트)가 잘리게 된다.
		// 잘린값은 2의 보수 형식으로 계산되며 음수값으로 변환된다
		// 1000 0000 0000 0000 0000 0000 0000 0000(32bit -> 8byte)
		
		// 각 왜곡은 작은 자료형으로 형변환시 발생할 수 있는 문제이고 강제 형변환은 값의 범위를 초과하지 않을 때만 사용해야한다
