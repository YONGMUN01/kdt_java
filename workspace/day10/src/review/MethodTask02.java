...
public class MethodTask02 {
	...
	// 4) 매개변수 => 정수형 변수 1개
	// 5) 실행할 문장 => 삼항연산자
	// 6) return => return 매개변수 % 2 == 0 ? "짝수입니다" : "홀추입니다";
	// 7) 리턴타입 변경 => String
...
//	
	...
	//		if 변수1 >= 3
	//			return 잠금
	//		if 상수id.equals(매개변수id) && 상수pw.equals(매개변수pw)
	//			변수1 초기화
	//			return 로그인 성공
	//		else
	//			변수1++
...
//		int tryCount = 0;
	...
	public static void main(String[] args) {
		...
		int[] numbers = {10, 20, 10, 20, 10, 20, 10, 20, 10, 10};
		System.out.println(mt.getSum(numbers));
		
		System.out.println("===========3번=============");
		// 매개변수 o, 리턴값 o => syso(객체명.메소드명(인수));
		System.out.println(mt.reverseStr1(null));
		System.out.println(mt.reverseStr1("hello"));
		...
		System.out.println(mt.loginTry("asmin", "1234"));
		System.out.println(mt.loginTry("asmin", "1234"));
		System.out.println(mt.loginTry("asmin", "1234"));
		System.out.println(mt.loginTry("asmin", "1234"));
