...
//      }
		...
		System.out.println(t1.getGender2("250625-1"));
	...
	// 3. 학생 3명의 수학점수, 국어점수, 영어점수를 받아 평균을 구하여(정수형) 각 학생별 학점 구하기
	...
	// 정수형 2차원배열 배열명 = new int[학생수][과목수];
	// 반복문(for 초기식 int i = 0; i < 학생수; i++)
	// 		번 학생의 점수를 입력하세요 출력
	//  	for(int j = 0; j < 과목수; j++)
	//				if(j == 0){
	//					subject = "수학"
