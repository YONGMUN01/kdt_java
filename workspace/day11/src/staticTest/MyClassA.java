...
public class MyClassA {
	...
	static void staticMethod1() {
		System.out.println("static 메소드1 호출되었습니다.");
//		instanceMethod();	// 스태틱 메소드에서 인스턴스 메소드 호출 불가
//		this.instanceVar = 1000;	// 스태틱 메소드에서 인스턴스 변수 접근 불가
		staticVar = 1000;
		System.out.println("static 메소드1에서 static 변수값 : " + staticVar);
		staticMethod2();
	...
	static void staticMethod2() {
		System.out.println("static 메소드2 호출되었습니다.");
	}
